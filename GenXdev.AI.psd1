...
RequiredModules = @(@{ModuleName = 'GenXdev.Data'; ModuleVersion = '1.128.2025'; }, 
...
AliasesToExport = 'Analyze-Image', 'corporatize', 'embed-text', 'emojify', 'findimages', 
               'Get-TextEmbedding', 'Get-Translation', 'hint', 'Invoke-LMStudioQuery', 
               'llm', 'llmaudiochat', 'llmchat', 'qllm', 'qlms', 'Query-Image', 
