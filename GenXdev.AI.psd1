...
RequiredModules = @(@{ModuleName = 'GenXdev.Queries'; ModuleVersion = '1.202.2025'; })
...
FunctionsToExport = 'Add-EmoticonsToText', 'Add-GenXdevMCPServerToLMStudio', 
               ...
               'Start-LMStudioApplication', 'Stop-GenXdevMCPServer', 
...
AliasesToExport = 'addimgdir', 'comparefaces', 'corporatize', 'diplomatize', 'dispicetext', 
               ...
               'gids', 'hint', 'indexcachedimages', 'Inititalize-ImageDatabase', 
               'initlmstudio', 'Invoke-LMStudioQuery', 'letsfixthis', 'li', 'lii', 'llm', 
               'llmaudiochat', 'llmchat', 'lmstudiowindow', 'objectdetection', 'qllm', 
               'qlms', 'Query-Image', 'recordandtranscribe', 'Recreate-ImageIndex', 
               'removeimagedata', 'removeimgdir', 'saveimagefaces', 'saveimageObjects', 
               'scenerecognition', 'setlmstudiowindow', 'showfoundimages', 
