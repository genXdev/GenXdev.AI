...
RequiredModules = @(@{ModuleName = 'GenXdev.Queries'; ModuleVersion = '1.308.2025'; })
...
FileList = '.gitignore', 'GenXdev.AI.ComfyUI.psm1', 'GenXdev.AI.csproj', 
               'GenXdev.AI.Data.psm1', 'GenXdev.AI.DeepStack.psm1', 
               'GenXdev.AI.LMStudio.psm1', 'GenXdev.AI.png', 'GenXdev.AI.psd1', 
               'GenXdev.AI.psm1', 'GenXdev.AI.Queries.psm1', 'LICENSE', 
               'powershell.jpg', 'programmer.jpg', 'README.md', 
               'lib\GenXdev.AI.deps.json', 'lib\GenXdev.AI.dll', 
               'lib\Microsoft.Windows.SDK.NET.dll', 'lib\WinRT.Runtime.dll', 
