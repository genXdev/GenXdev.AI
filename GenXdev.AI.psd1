...
RequiredModules = @(@{ModuleName = 'GenXdev.Queries'; ModuleVersion = '1.302.2025'; })

# Assemblies that must be loaded prior to importing this module
RequiredAssemblies = 'lib\GenXdev.AI.dll'
...
NestedModules = @('lib\GenXdev.AI.dll', 
...
FunctionsToExport = 'Add-EmoticonsToText', 'Approve-NewTextFileContent', 
               'Compare-ImageFaces', 'ConvertComfyImageFormat', 
               'ConvertFrom-CorporateSpeak', 'ConvertFrom-DiplomaticSpeak', 
               'ConvertTo-CorporateSpeak', 'ConvertTo-DiplomaticSpeak', 
               'ConvertTo-LMStudioFunctionDefinition', 'CreateComfySDXLWorkflow', 
               'CreateComfyUniversalWorkflow', 'DownloadComfyResults', 
               'EnsureComfyUI', 'EnsureComfyUIModel', 'EnsureDeepStack', 
               'EnsureGithubCLIInstalled', 'EnsureHuggingFace', 'EnsureLMStudio', 
               'EnsurePaintNet', 'EnsurePip', 'EnsurePython', 
               ...
               'Get-AILLMSettings', 'Get-Fallacy', 'Get-ImageDetectedFaces', 
               ...
               'Initialize-LMStudioModel', 'Invoke-AIPowershellCommand', 
               'Invoke-ComfyUIImageGeneration', 'Invoke-CommandFromToolCall', 
               'Invoke-HuggingFaceCli', 'Invoke-ImageEnhancement', 
               ...
               'New-LLMAudioChat', 'New-LLMTextChat', 'QueueComfyWorkflow', 
               'Register-AllFaces', 'Register-Face', 'Remove-ImageDirectories', 
               'Remove-ImageMetaData', 'ResizeComfyInputImage', 
               'Save-FoundImageFaces', 'Save-FoundImageObjects', 
               'Save-Transcriptions', 'Set-AICommandSuggestion', 
               'Set-AIImageCollection', 'Set-AILLMSettings', 'Set-ComfyUIModelPath', 
               'Set-GenXdevAICommandNotFoundAction', 'Set-WindowsWallpaperEx', 
               'SetComfyUIProcessPriority', 'Show-FoundImagesInBrowser', 
               'Show-GenXdevScriptErrorFixInIde', 'Start-AudioTranscription', 
               'Start-GenXdevMCPServer', 'Stop-GenXdevMCPServer', 
...
CmdletsToExport = 'Add-GenXdevMCPServerToLMStudio', 'Add-ImageDirectories', 
               'Convert-DotNetTypeToLLMType', 'Get-AIKnownFacesRootpath', 
               'Get-AIMetaLanguage', 'Get-ComfyUIModelPath', 'Get-CpuCore', 
               'Get-HasCapableGpu', 'Get-LMStudioLoadedModelList', 
               'Get-LMStudioModelList', 'Get-LMStudioPaths', 'Get-NumberOfCpuCores', 
               'Get-VectorSimilarity', 'Install-LMStudioApplication', 
               'Invoke-WinMerge', 'Set-AIKnownFacesRootpath', 'Set-AIMetaLanguage', 
               'Set-ComfyUIBackgroundImage', 'Set-ImageIndexPath', 
               'Start-LMStudioApplication', 'Stop-ComfyUI', 'Test-ComfyUIQueueEmpty', 
...
FileList = '.gitignore', 'GenXdev.AI-Help.xml', 'GenXdev.AI.ComfyUI.psm1', 
               'GenXdev.AI.csproj', 'GenXdev.AI.Data.psm1', 
               'GenXdev.AI.DeepStack.psm1', 'GenXdev.AI.LMStudio.psm1', 
               'GenXdev.AI.png', 'GenXdev.AI.psd1', 'GenXdev.AI.psm1', 
               'GenXdev.AI.Queries.psm1', 'LICENSE', 'powershell.jpg', 
               'programmer.jpg', 'README.md', 'lib\GenXdev.AI.deps.json', 
               'lib\GenXdev.AI.dll', 'lib\Microsoft.Windows.SDK.NET.dll', 
               ...
               'Functions\GenXdev.AI\Get-CpuCore.cs', 
               'Functions\GenXdev.AI\Get-HasCapableGpu.cs', 
               ...
               'Functions\GenXdev.AI\Invoke-WinMerge.cs', 
               ...
               'Functions\GenXdev.AI.Queries\Add-ImageDirectories.cs', 
               ...
               'Functions\GenXdev.AI\Test-DeepLinkImageFile.cs', 
               ...
               'Functions\GenXdev.AI.Queries\Get-AIKnownFacesRootpath.cs', 
               'Functions\GenXdev.AI.Queries\Get-AIMetaLanguage.cs', 
               ...
               'Functions\GenXdev.AI.ComfyUI\Get-ComfyUIModelPath.cs', 
               'Functions\GenXdev.AI.Queries\Invoke-ImageObjectsUpdate.ps1', 
               'lib\runtimes\win-arm64\ggml-whisper.dll', 
               'Functions\GenXdev.AI.LMStudio\Add-GenXdevMCPServerToLMStudio.cs', 
               ...
               'Functions\GenXdev.AI.ComfyUI\Stop-ComfyUI.cs', 
               'Functions\GenXdev.AI.LMStudio\Install-LMStudioApplication.cs', 
               'Functions\GenXdev.AI.ComfyUI\SupportedComfyUIModels.json', 
               'Functions\GenXdev.AI.LMStudio\README.md', 
               'Functions\GenXdev.AI.ComfyUI\Test-ComfyUIQueueEmpty.cs', 
               'Functions\GenXdev.AI.LMStudio\Start-LMStudioApplication.cs', 
               'Functions\GenXdev.AI.ComfyUI\UploadComfyImage.ps1', 
               'Functions\GenXdev.AI.Queries\Set-AIImageCollection.ps1', 
               'Functions\GenXdev.AI.LMStudio\Test-LMStudioInstallation.cs', 
               'Functions\GenXdev.AI.Queries\Set-AIKnownFacesRootpath.cs', 
               'lib\runtimes\win-x64\ggml-base-whisper.dll', 
               'Functions\GenXdev.AI.ComfyUI\WaitForComfyCompletion.ps1', 
               'Functions\GenXdev.AI.LMStudio\Test-LMStudioProcess.cs', 
               'Functions\GenXdev.AI.Queries\Set-AIMetaLanguage.cs', 
               'lib\runtimes\win-x64\ggml-cpu-whisper.dll', 
               'Functions\GenXdev.AI.Queries\Set-ImageIndexPath.cs', 
               ...
               'Tests\GenXdev.AI.LMStudio\Get-TextTranslation.Tests.ps1', 
