...
RequiredModules = @(@{ModuleName = 'GenXdev.Queries'; ModuleVersion = '1.170.2025'; })
...
FunctionsToExport = 'Add-EmoticonsToText', 'Approve-NewTextFileContent', 'AssureLMStudio', 
               ...
               'Get-NumberOfCpuCores', 'Get-ScriptExecutionErrorFixPrompt', 
               ...
               'Invoke-ImageKeywordUpdate', 'Invoke-LLMBooleanEvaluation', 
...
AliasesToExport = 'Analyze-Image', 'corporatize', 'diplomatize', 'embed-text', 'emojify', 
               'equalstrue', 'findimages', 'Get-TextEmbedding', 'getfixprompt', 
               'getlist', 'getstring', 'hint', 'Invoke-LMStudioQuery', 'letsfixthis', 
               'llm', 'llmaudiochat', 'llmchat', 'moremovietitles', 'qllm', 'qlms', 
               'Query-Image', 'recordandtranscribe', 'spellcheck', 'transcribe', 
