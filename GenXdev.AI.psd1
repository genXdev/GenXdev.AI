...
@{
  ...
  RequiredModules      = @(@{ModuleName = 'GenXdev.Data'; ModuleVersion = '1.112.2025' }, @{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.112.2025' }, @{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion = '1.112.2025' }, @{ModuleName = 'GenXdev.Queries'; ModuleVersion = '1.112.2025' }, @{ModuleName = 'GenXdev.Console'; ModuleVersion = '1.112.2025' }, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.112.2025' });
