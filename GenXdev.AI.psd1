...
FunctionsToExport = 'Add-EmoticonsToText', 'Approve-NewTextFileContent', 
               ...
               'EnsureWinMergeInstalled', 'Find-Image', 'GenerateMasonryLayoutHtml', 
               'Get-CpuCore', 'Get-Fallacy', 'Get-HasCapableGpu', 
               'Get-ImageDetectedFaces', 'Get-ImageDetectedObjects', 
               'Get-ImageScene', 'Get-LMStudioLoadedModelList', 
               ...
               'Invoke-ImageObjectsUpdate', 'Invoke-LLMBooleanEvaluation', 
               ...
               'Register-AllFaces', 'Register-Face', 'Remove-ImageMetaData', 
               'Save-Transcriptions', 'Set-AICommandSuggestion', 
               'Set-GenXdevAICommandNotFoundAction', 'Set-ImageDirectory', 
