...
@{
  ...
  RequiredModules      = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.64.2024' }, @{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion = '1.64.2024' }, @{ModuleName = 'GenXdev.Queries'; ModuleVersion = '1.64.2024' }, @{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion = '1.64.2024' }, @{ModuleName = 'GenXdev.Console'; ModuleVersion = '1.64.2024' }, @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.64.2024' });
